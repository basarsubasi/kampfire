...
#### macOS (arm64)
```bash
curl -Lo kampfire https://github.com/basarsubasi/kampfire/releases/download/1.2.0/kampfire-1.2.0-darwin-arm64
chmod +x kampfire
...
#### Linux (amd64)
```bash
curl -Lo kampfire https://github.com/basarsubasi/kampfire/releases/download/1.2.0/kampfire-1.2.0-linux-amd64
chmod +x kampfire
sudo mv kampfire /usr/local/bin/kampfire
```
