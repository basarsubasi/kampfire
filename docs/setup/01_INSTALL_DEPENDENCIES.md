...
> **Tip:** If deploying your cluster from scratch with Ansible, the **[agent-sandbox-playbook](https://github.com/basarsubasi/agent-sandbox-playbook)** repository automates the installation of Kyverno, Agent Sandbox v1.0.0, and Kata-FC runtime classes.
