...
> **Automated Setup with Ansible:** The **[agent-sandbox-playbook](https://github.com/basarsubasi/agent-sandbox-playbook)** repository contains ready-to-run Ansible playbooks that configure the containerd `kata-fc` runtime, devmapper thin-pools, OpenEBS LVM CSI, and the Kyverno mutation policy automatically.
